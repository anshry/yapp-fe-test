...
export const Navbar: React.FC = () => {
  return (
    <nav className="bg-base-dark-secondary border-b-base-placeholder fixed z-[100] flex h-[60px] w-full items-center justify-between border-b px-4 text-white transition-colors duration-300 lg:px-6">
      <div>
        <Link to="/" className="flex items-center">
          <img src="/images/assets/img-logo.webp" alt="Raflux Logo" className="h-[22px] w-auto object-contain" />
        </Link>
      </div>
      <button 
