...
export const NftCard: React.FC<NftCardProps> = ({ imageSrc, title, price, hideRightBorder }) => {
  return (
    <div className={`flex items-center justify-center w-full border-base-placeholder border-b lg:border-b-0 ${!hideRightBorder ? 'border-r' : ''}`}>
      <div className="flex items-center bg-background-2 w-full relative justify-center shadow-sm h-[223px]">
        <div className="flex flex-col gap-2.5 items-center justify-center w-full relative h-full">
