...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <TooltipPrimitive.Portal>
        <TooltipPrimitive.Content
            ...
            className={cn(
                "z-50 overflow-hidden rounded-md bg-base-dark-secondary border border-base-placeholder px-3 py-1.5 text-xs text-foreground shadow-xl transition-all duration-200",
